...
class SupercellQuiz {
    ...
    loadQuestions() {
        // Questions d'exemple sur l'univers Supercell
        this.questions = [
            {
                question: "Quel est le nom de la monnaie premium dans Clash Royale ?",
                category: "Clash Royale",
                answers: ["Gemmes", "Or", "Élixir", "Étoiles"],
                correct: 0
            },
            {
                question: "Combien d'élixir coûte le sort 'Foudre' dans Clash Royale ?",
                category: "Clash Royale", 
                answers: ["4", "5", "6", "7"],
                correct: 2
            },
            {
                question: "Quel brawler a pour super une tourelle dans Brawl Stars ?",
                category: "Brawl Stars",
                answers: ["Penny", "Jessie", "Pam", "Toutes les réponses"],
                correct: 3
            },
            {
                question: "Dans Clash of Clans, quel est le niveau maximum de l'Hôtel de Ville ?",
                category: "Clash of Clans",
                answers: ["13", "14", "15", "16"],
                correct: 2
            },
            {
                question: "Quel est le nom du PDG et fondateur de Supercell ?",
                category: "Supercell",
                answers: ["Mikael Hed", "Ilkka Paananen", "Riccardo Zacconi", "King Digital"],
                correct: 1
            },
            {
                question: "Dans Brawl Stars, quel mode de jeu consiste à collecter des gemmes ?",
                category: "Brawl Stars",
                answers: ["Survivant", "Siège", "Chasse aux Gemmes", "Brawl Ball"],
                correct: 2
            },
            {
                question: "Quelle carte légendaire coûte 3 d'élixir dans Clash Royale ?",
                category: "Clash Royale",
                answers: ["Princesse", "Bûcheron", "Mineur", "Chien de Lave"],
                correct: 0
            },
            {
                question: "Dans quel pays Supercell a-t-elle été fondée ?",
                category: "Supercell",
                answers: ["Suède", "Norvège", "Finlande", "Danemark"],
                correct: 2
            },
            {
                question: "Quel brawler mythique peut devenir invisible dans Brawl Stars ?",
                category: "Brawl Stars",
                answers: ["Leon", "Crow", "Spike", "Sandy"],
                correct: 0
            },
            {
                question: "Dans Clash of Clans, comment s'appelle la ligue la plus élevée ?",
                category: "Clash of Clans",
                answers: ["Ligue Titan", "Ligue Légende", "Ligue Champion", "Ligue Cristal"],
                correct: 1
            }
        ];
